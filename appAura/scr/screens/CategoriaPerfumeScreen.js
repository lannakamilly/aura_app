...
const products = [
  {
    ...
    price: 'R$129,90',
    rating: 4.8,
    imageUrl: 'https://res.cloudinary.com/beleza-na-web/image/upload/w_1500,f_auto,fl_progressive,q_auto:eco,w_800/v1/imagens/product/74028/7d9ae2b9-cc1b-49d2-a760-a4d9d97ea793-good-girl-carolina-herrera-eau-de-parfum-perfume-feminino-150ml.png',
    isFavorite: true,
  },
  {
    id: 'p2',
  ...
  {
    id: 'p3',
    name: 'Vizzela Cosméticos Ondas de Aventura Body Splash Deo Colônia Infantil',
    originalPrice: 'R$99,90',
    price: 'R$79,90',
    rating: 4.9,
    imageUrl: 'https://res.cloudinary.com/beleza-na-web/image/upload/w_1500,f_auto,fl_progressive,q_auto:eco,w_800/v1/imagens/product/MP299589/8739d06e-2317-4806-9651-9f5053b5c072-mp299589-vizzela-body-splash-deo-colonia-infantil-200ml-ondas-de-aventura.png',
    isFavorite: true,
  },
  {
    id: 'p4',
    name: 'Perfume Ilía Secreto Feminino Natura 50ml',
    originalPrice: 'R$30,00',
    price: 'R$22,20',
    rating: 4.2,
    imageUrl: 'https://fimgs.net/mdimg/perfume/o.48977.jpg',
    isFavorite: false,
  },
  // Mais produtos para simular a rolagem
  {
    id: 'p5',
    name: 'Floratta Red Desodorante Colônia O Boticário 75ml',
    originalPrice: 'R$55,00',
    price: 'R$45,00',
    rating: 4.6,
    imageUrl: 'https://res.cloudinary.com/beleza-na-web/image/upload/w_1500,f_auto,fl_progressive,q_auto:eco,w_1800,c_limit/e_trim/v1/imagens/product/B75792/2a88a4b5-2cce-4b26-a4eb-f1181510a2cf-floratta-red-o-boticario-desodorante-colonia-feminino-75ml.png',
    isFavorite: false,
  },
  {
    id: 'p6',
    name: 'Egeo Dolce Desodorante Colônia 90ml | O Boticário',
    originalPrice: 'R$65,00',
    price: 'R$59,99',
    rating: 4.7,
    imageUrl: 'https://res.cloudinary.com/beleza-na-web/image/upload/w_1500,f_auto,fl_progressive,q_auto:eco,w_1800,c_limit/e_trim/v1/imagens/products/B82688/Egeo-Des-Col-Dolce-C-Car-90Ml-B82688_.jpg',
    isFavorite: true,
  },
];
