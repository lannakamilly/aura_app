...
// 🎯 ALTERAÇÃO PRINCIPAL: ID da Categoria Perfume (ID = 2)
const CATEGORY_ID = 2; 
...
// ======================================================
// TELA CATEGORIA PERFUME (Exportada)
// ======================================================
export default function CategoriaPerfumeScreen() {
    const navigation = useNavigation();
        ...
        <View style={screenStyles.container}>
            ...
            {loading ? (
                ...
                <View style={screenStyles.emptyContainer}>
                    ...
                    <Text style={screenStyles.emptySubtext}>Verifique se a coluna 'category_id' na tabela 'products' está definida como {CATEGORY_ID} para os produtos de Perfume.</Text>
                </View>
            ) : (
                <FlatList
                    data={products}
