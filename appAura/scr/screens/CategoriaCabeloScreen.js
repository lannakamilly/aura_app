...
// ======================================================
// COMPONENTE: TOAST DE SUCESSO (NOVO)
// ======================================================
...
// ======================================================
// COMPONENTE: ProductDetailModal (ATUALIZADO)
// ======================================================

// O modal agora aceita 'onCartSuccess' para feedback sem navegação
const ProductDetailModal = ({ product, visible, onClose, userId, onCartSuccess }) => { 
    ...
    const handleAddToCart = async () => {
        // 1. Verificação de Dados (Proteção contra produtos com dados incompletos)
        ...
        // 4. Resposta e Feedback (LÓGICA ALTERADA)
        if (error) {
...
// ======================================================
// TELA CATEGORIA CABELO (Exportada - ATUALIZADA)
// ======================================================
export default function CategoriaCabeloScreen() {
    const navigation = useNavigation();
    ...
    const [toastMessage, setToastMessage] = useState(null); // 🎯 NOVO ESTADO: Mensagem Toast
    
    // EFEITO: Carregar ID do usuário e produtos
    useEffect(() => {
        const loadAndFetch = async () => {
             // 1. Carrega o ID do usuário
            const id = await AsyncStorage.getItem('user_session_id'); 
            setCurrentUserId(id); 
            // 2. Chama a função de busca
    ...
    const fetchCategoryProducts = async () => {
        ...
        if (!error) {
            ...
            console.error("Erro ao buscar produtos da categoria Cabelo:", error.message);
    ...
    return (
        <View style={screenStyles.container}>
            ...
            <View style={screenStyles.header}>
                ...
                <Text style={screenStyles.headerTitle}>Cabelo</Text>
            ...
            {loading ? (
                ...
                <View style={screenStyles.emptyContainer}>
                    ...
                    <Text style={screenStyles.emptyText}>Nenhum produto encontrado na categoria Cabelo.</Text>
                </View>
            ) : (
                <FlatList
                    data={products}
                    ...
                    // Aumentando o padding inferior para garantir espaço para a Tab Navigation (conforme sua instrução)
            ...
            <ProductDetailModal
                ...
                onCartSuccess={showToast} // Passa a função para mostrar o Toast
            />
            
            {/* 🎯 NOVO COMPONENTE: O Toast Message */}
...
const screenStyles = StyleSheet.create({
    ...
    listContentContainer: {
        paddingHorizontal: HORIZONTAL_PADDING,
        paddingBottom: 100, // Espaço para a Tab Navigation (Conforme instrução salva)
    },
    row: {
        justifyContent: 'space-between',
